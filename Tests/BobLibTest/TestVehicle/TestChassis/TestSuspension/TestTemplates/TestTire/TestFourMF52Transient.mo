...
model TestFourMF52Transient
  ...
  BobLib.Chassis.Suspension.Tires.MF52Tire tireFL(pPartialWheel = pCar.pFrPartialWheel,
                                                                    pTireModel = pCar.pFrTireModel,
                                                                    redeclare BobLib.Chassis.Suspension.Tires.TirePhysics.Wheel1DOF_Y wheelModel(
                                                                      partialWheelParams = pCar.pFrPartialWheel,
                                                                      wheel1DOF_YParams = pCar.pFrTire1DOF_YParams),
                                                                    redeclare BobLib.Chassis.Suspension.Tires.MF52.SlipModel.TransientSlip slipModel) annotation(
    Placement(transformation(origin = {-70, 80}, extent = {{10, -10}, {-10, 10}})));

  BobLib.Chassis.Suspension.Tires.MF52Tire tireFR(pPartialWheel = PartialWheelRecord(R0 = pCar.pFrPartialWheel.R0,
                                                                                                       rimR0 = pCar.pFrPartialWheel.rimR0,
                                                                    ...
                                                                    pTireModel = pCar.pFrTireModel,
                                                                    redeclare BobLib.Chassis.Suspension.Tires.TirePhysics.Wheel1DOF_Y wheelModel(partialWheelParams = PartialWheelRecord(R0 = pCar.pFrPartialWheel.R0,
                                                                                                                                                                                                          rimR0 = pCar.pFrPartialWheel.rimR0,
                                                                                                                                                                                                          rimWidth = pCar.pFrPartialWheel.rimWidth,
                                                                                                                                                                                                          staticAlpha = -pCar.pFrPartialWheel.staticAlpha,
                                                                                                                                                                                                          staticGamma = -pCar.pFrPartialWheel.staticGamma),
  ...
  BobLib.Chassis.Suspension.Tires.MF52Tire tireRL(pPartialWheel = pCar.pFrPartialWheel,
                                                                    pTireModel = pCar.pFrTireModel,
                                                                    redeclare BobLib.Chassis.Suspension.Tires.TirePhysics.Wheel1DOF_Y wheelModel(
                                                                      partialWheelParams = pCar.pFrPartialWheel,
  ...
  BobLib.Chassis.Suspension.Tires.MF52Tire tireRR(pPartialWheel = PartialWheelRecord(R0 = pCar.pFrPartialWheel.R0,
                                                                                                       rimR0 = pCar.pFrPartialWheel.rimR0,
                                                                                                       rimWidth = pCar.pFrPartialWheel.rimWidth,
                                                                                                       staticAlpha = -pCar.pFrPartialWheel.staticAlpha,
                                                                                                       staticGamma = -pCar.pFrPartialWheel.staticGamma),
  ...
  BobLib.Utilities.Mechanics.MultiBody.ContactMechanics.GroundPhysics groundFL annotation(
    Placement(transformation(origin = {-70, 40}, extent = {{-10, -10}, {10, 10}})));
  BobLib.Utilities.Mechanics.MultiBody.ContactMechanics.GroundPhysics groundFR annotation(
    Placement(transformation(origin = {70, 40}, extent = {{10, -10}, {-10, 10}})));
  BobLib.Utilities.Mechanics.MultiBody.ContactMechanics.GroundPhysics groundRL annotation(
    Placement(transformation(origin = {-70, -40}, extent = {{-10, -10}, {10, 10}})));
  BobLib.Utilities.Mechanics.MultiBody.ContactMechanics.GroundPhysics groundRR annotation(
    Placement(transformation(origin = {70, -40}, extent = {{10, -10}, {-10, 10}})));

  Modelica.Blocks.Sources.Ramp steerRamp(duration = 0,
...
initial equation
  tireFL.wheelModel.hubAxis.w = velocity / pCar.pFrPartialWheel.R0;
  tireFR.wheelModel.hubAxis.w = velocity / pCar.pFrPartialWheel.R0;
  tireRL.wheelModel.hubAxis.w = velocity / pCar.pFrPartialWheel.R0;
  tireRR.wheelModel.hubAxis.w = velocity / pCar.pFrPartialWheel.R0;
