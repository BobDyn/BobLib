within BobLibTest.TestVehicle.TestChassis.TestSuspension.TestTemplates.TestDoubleWishbone;
...
model TestDoubleWishbone
  ...
  // Rack
  BobLib.Chassis.Suspension.Templates.SteeringRack.RackAndPinion rackAndPinion(pRack = pVehicle.pFrRack,
  ...
  BobLib.Chassis.Suspension.Templates.DoubleWishbone.WishboneUprightLoop wishboneUprightLoop(pDW = pVehicle.pFrDW,
  ...
  // Tie rod
  BobLib.Chassis.Suspension.Linkages.Rod tieRod(r_a = pVehicle.pFrRack.leftPickup,
