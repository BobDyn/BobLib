within BobLibTest.TestVehicle.TestChassis.TestSuspension;
...
model TestFrAxleDW
  ...
  // Front axle
  BobLib.Chassis.Suspension.FrAxleDW_BC_Stabar frAxleDW(pAxle = pVehicle.pFrAxleDW, pRack = pVehicle.pFrRack, pStabar = pVehicle.pFrStabar, pLeftPartialWheel = pVehicle.pFrPartialWheel, pLeftDW = pVehicle.pFrDW, pLeftAxleMass = pVehicle.pFrAxleMass,

  //  redeclare BobLib.Chassis.Suspension.Linkages.Rod leftTieRod(r_a = frAxleDW.pRack.leftPickup, r_b = frAxleDW.pLeftDW.tie_o , kinematicConstraint = true),

  //  redeclare BobLib.Chassis.Suspension.Linkages.Rod rightTieRod(r_a = Vector.mirrorXZ(pVehicle.pFrRack.leftPickup), r_b = Vector.mirrorXZ(pVehicle.pFrDW.tie_o), kinematicConstraint = true),
  redeclare BobLib.Chassis.Suspension.Tires.BaseTire leftTire(redeclare BobLib.Chassis.Suspension.Tires.MF52.SlipModel.NoSlip slipModel), redeclare BobLib.Chassis.Suspension.Tires.BaseTire rightTire(redeclare BobLib.Chassis.Suspension.Tires.MF52.SlipModel.NoSlip slipModel)) annotation(
