...
model TestCFDAeroMap
  ...
  BobLib.Aero.CFDAeroMap aero(pAero = pAero) annotation(
  ...
  BobLib.Atmospheres.Interfaces.AtmosphereBus atmosphereBus annotation(
    Placement(transformation(origin = {10, 60}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Sources.Constant airTemperature(k = 293.15) annotation(
    Placement(transformation(origin = {-60, -40}, extent = {{-10, -10}, {10, 10}})));

  Modelica.Blocks.Sources.Constant relativeHumidity(k = 0) annotation(
...
equation
  ...
  connect(airTemperature.y, atmosphereBus.airTemperature) annotation(
    Line(points = {{-49, -40}, {10, -40}, {10, 60}}, color = {0, 0, 127}));
  connect(relativeHumidity.y, atmosphereBus.relativeHumidity) annotation(
    Line(points = {{-49, -60}, {10, -60}, {10, 60}}, color = {0, 0, 127}));
  connect(pressure.y, atmosphereBus.pressure) annotation(
    Line(points = {{-49, -80}, {10, -80}, {10, 60}}, color = {0, 0, 127}));
