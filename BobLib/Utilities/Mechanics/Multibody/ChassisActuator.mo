...
model ChassisActuator
  ...
  Modelica.Mechanics.MultiBody.Joints.Prismatic heaveDOF(
    n = {0, 0, 1},
    useAxisFlange = true,
    animation = true) annotation(Placement(transformation(origin = {50, 50}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
  ...
  Modelica.Mechanics.MultiBody.Joints.Revolute rollDOF(
    n = {1, 0, 0},
    useAxisFlange = true) annotation(Placement(transformation(origin = {0, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
