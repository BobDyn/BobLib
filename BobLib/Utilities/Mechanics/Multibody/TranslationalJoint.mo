...
model TranslationalJoint
  ...
  Modelica.Mechanics.MultiBody.Joints.Prismatic FreeY(
    n = {0, 1, 0},
    s(start = y0, fixed = true),
    v(start = vy0, fixed = true)) annotation(
    Placement(transformation(extent = {{-10, -10}, {10, 10}})));
  Modelica.Mechanics.MultiBody.Joints.Prismatic FreeZ(
    n = {0, 0, 1},
    s(start = z0, fixed = true),
    v(start = vz0, fixed = true)) annotation(
    Placement(transformation(origin = {50, 0}, extent = {{-10, -10}, {10, 10}})));
