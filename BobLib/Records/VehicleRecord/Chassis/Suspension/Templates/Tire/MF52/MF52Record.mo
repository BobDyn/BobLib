...
<p>
Record <code>MF52Record</code> groups all Magic Formula 5.2 tire coefficients used by the aggregate evaluator.
</p>
<p>
It contains pure-slip, combined-slip, relaxation, and setup records for longitudinal force, lateral force, and tire moments.
</p>
</html>"));
end MF52Record;
