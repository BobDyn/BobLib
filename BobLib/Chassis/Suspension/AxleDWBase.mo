within BobLib.Chassis.Suspension;

partial model AxleDWBase

  extends BobLib.Icons.AxleDWBaseIcon;
  ...
  import BobLib.Records.VehicleRecord.Chassis.Suspension.Templates.SteeringRack.RackAndPinionRecord;
  ...
  // Tires
  replaceable BobLib.Chassis.Suspension.Tires.BaseTire leftTire(pPartialWheel = pLeftPartialWheel) annotation(
    Placement(transformation(origin = {-160, 50}, extent = {{10, -10}, {-10, 10}})));

  replaceable BobLib.Chassis.Suspension.Tires.BaseTire rightTire(pPartialWheel = pRightPartialWheel) annotation(
    Placement(transformation(origin = {160, 50}, extent = {{-10, -10}, {10, 10}})));
  ...
  BobLib.Chassis.Suspension.Linkages.Rod rightTieRod(
  ...
  BobLib.Chassis.Suspension.Templates.SteeringRack.RackAndPinion rackAndPinion(
    pRack = pRack,
