...
model RrAxleDW_BC_Stabar "Double wishbone axle with bellcranks mounting to shock, push/pullrod, and stabar"

  import SI = Modelica.Units.SI;
  import Modelica.Math.Vectors;
  import BobLib.Utilities.Math.Vector.mirrorXZ;
  import BobLib.Records.VehicleRecord.Chassis.Suspension.AxleDW_BC_StabarRecord;

  // Record parameters
  parameter AxleDW_BC_StabarRecord pAxle;

  extends BobLib.Chassis.Suspension.AxleDWBase;
  extends BobLib.Icons.SteeringWheelOverlayIcon;

  // Left bellcrank
  BobLib.Chassis.Suspension.Linkages.Bellcrank3 leftBellcrank(
  ...
  // Left shock
  BobLib.Chassis.Suspension.Linkages.ShockLinkage leftShockLinkage(
  ...
  // Right bellcrank
  BobLib.Chassis.Suspension.Linkages.Bellcrank3 rightBellcrank(
  ...
  // Right shock
  BobLib.Chassis.Suspension.Linkages.ShockLinkage rightShockLinkage(
  ...
  // Stabar
  BobLib.Chassis.Suspension.Templates.Stabar.Stabar stabar(
    pStabar = pStabar,
...
public
  BobLib.Chassis.Suspension.Linkages.Rod leftPushrod(
    jointDiameter = jointDiameter,
  ...
  BobLib.Chassis.Suspension.Linkages.Rod rightPushrod(
    jointDiameter = jointDiameter,
    kinematicConstraint = true,
    linkDiameter = linkDiameter,
...
equation
  ...
  connect(rightShockLinkage.frame_a, rightBellcrank.pickupFrame2) annotation(
    Line(points = {{50, -40}, {60, -40}, {60, -20}}, color = {95, 95, 95}));
  connect(leftDroplink.frame_b, leftBellcrank.pickupFrame3) annotation(
    Line(points = {{-70, -80}, {-50, -80}, {-50, -30}}, color = {95, 95, 95}));
  connect(rightDroplink.frame_b, rightBellcrank.pickupFrame3) annotation(
    Line(points = {{70, -80}, {50, -80}, {50, -30}}, color = {95, 95, 95}));
...
<p>
Model <code>RrAxleDW_BC_Stabar</code> implements a rear double-wishbone axle with bellcrank-actuated spring/damper motion and a stabilizer bar.
</p>
<p>
