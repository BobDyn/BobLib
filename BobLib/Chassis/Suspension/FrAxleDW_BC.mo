...
model FrAxleDW_BC "Double wishbone axle with bellcranks mounting to shock and push/pullrod"
  ...
  import BobLib.Records.VehicleRecord.Chassis.Suspension.AxleDW_BCRecord;
  ...
  // Left bellcrank
  BobLib.Chassis.Suspension.Linkages.Bellcrank2 leftBellcrank(
  ...
  // Right bellcrank
  BobLib.Chassis.Suspension.Linkages.Bellcrank2 rightBellcrank(
...
<p>
Model <code>FrAxleDW_BC</code> implements a front double-wishbone axle with bellcrank-actuated spring/damper motion.
</p>
<p>
