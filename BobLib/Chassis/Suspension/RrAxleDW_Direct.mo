...
model RrAxleDW_Direct "Double wishbone axle with direct-acting suspension"
  ...
  import BobLib.Records.VehicleRecord.Chassis.Suspension.AxleDW_DirectRecord;
...
protected
  final parameter SI.Position leftRodWishboneMount[3] = if pAxle.rodToLower then pLeftDW.lower_o else pLeftDW.upper_o
    "Outboard wishbone joint used as the spring/damper apex reference";
...
equation
  ...
  if pAxle.rodToLower then
    connect(toLeftApex.frame_a, leftWishboneUprightLoop.lowerFrame_o) annotation(
      Line(points = {{-80, -20}, {-68, -20}, {-68, 22}}, color = {95, 95, 95}));
    ...
    connect(toLeftApex.frame_a, leftWishboneUprightLoop.upperFrame_o) annotation(
      Line(points = {{-80, -20}, {-68, -20}, {-68, 78}}, color = {95, 95, 95}));
  ...
  connect(toLeftApex.frame_b, leftShockLinkage.frame_a) annotation(
    Line(points = {{-100, -20}, {-110, -20}, {-110, -30}, {-50, -30}}, color = {95, 95, 95}));
