within BobLib.Chassis.Suspension.Templates.Stabar;

model Stabar "Stabar with rigid arms and compliant torsion bar"

  extends BobLib.Icons.StabarIcon;
...
<p>
Model <code>Stabar</code> represents a stabilizer-bar linkage with rigid arms and compliant torsion-bar behavior.
</p>
<p>
It couples left and right suspension travel through the bar geometry and rate supplied by the axle record.
</p>
</html>"));
end Stabar;