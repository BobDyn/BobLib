...
model Bellcrank3
  ...
  extends BobLib.Icons.Bellcrank3Icon;
  ...
  Modelica.Mechanics.MultiBody.Visualizers.FixedShape side_4(
    ...
    shapeType = "cylinder",
    animation = not headless) annotation(
    Placement(transformation(origin = {40, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
...
equation
  ...
  connect(toThirdPickup.frame_b, pickupFrame3) annotation(
    Line(points = {{50, 0}, {60, 0}, {60, 60}, {0, 60}, {0, 100}}, color = {95, 95, 95}));
  connect(pickupFrame1, toFirstPickup.frame_b) annotation(
    Line(points = {{0, -100}, {0, -60}, {-20, -60}, {-20, 0}, {-30, 0}, {-30, 0}}));
  ...
  connect(side_4.frame_a, toThirdPickup.frame_b) annotation(
    Line(points = {{50, 30}, {60, 30}, {60, 0}, {50, 0}}, color = {95, 95, 95}));
  annotation(Diagram,
    Icon(graphics = {
