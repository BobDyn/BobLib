within BobLib.Chassis.Suspension.Linkages.Templates;
...
<p>
Model <code>TabularCompliant</code> represents a shared compliant-line template used by suspension linkage assemblies.
</p>
<p>
