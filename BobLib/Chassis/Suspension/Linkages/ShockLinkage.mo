...
model ShockLinkage
  ...
  extends BobLib.Icons.ShockLinkageIcon;
  ...
  // Force elements
  BobLib.Chassis.Suspension.Linkages.TabularSpring TabularSpring(
    springTable = springTable,
    s_0 = s_0) annotation(
    Placement(transformation(origin = {0, 30}, extent = {{-10, -10}, {10, 10}})));

  BobLib.Chassis.Suspension.Linkages.TabularDamper TabularDamper(damperTable = damperTable) annotation(
