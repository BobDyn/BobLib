within BobLib.Chassis.Suspension.Tires.TirePhysics;
...
model Wheel2DOF_YZ
  ...
  extends BobLib.Chassis.Suspension.Tires.TirePhysics.Templates.PartialWheel(inertia(J = wheel1DOF_YParams.wheelJ));
