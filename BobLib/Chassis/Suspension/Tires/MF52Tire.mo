...
model MF52Tire
  ...
  import BobLib.Chassis.Suspension.Tires.MF52;

  import BobLib.Records.VehicleRecord.Chassis.Suspension.Templates.Tire.MF52.MF52Record;

  extends BobLib.Chassis.Suspension.Tires.BaseTire(realExpressionFx(y = Fx),
