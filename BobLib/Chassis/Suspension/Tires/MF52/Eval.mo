within BobLib.Chassis.Suspension.Tires.MF52;

function Eval

  import SI = Modelica.Units.SI;

  import BobLib.Records.VehicleRecord.Chassis.Suspension.Templates.Tire.MF52.*;
  import BobLib.Records.VehicleRecord.Chassis.Suspension.Templates.Tire.MF52.PureSlip.*;
  import BobLib.Records.VehicleRecord.Chassis.Suspension.Templates.Tire.MF52.CombinedSlip.*;

  import BobLib.Chassis.Suspension.Tires.MF52.PureSlip.*;
  import BobLib.Chassis.Suspension.Tires.MF52.CombinedSlip.*;
