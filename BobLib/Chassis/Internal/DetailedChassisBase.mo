within BobLib.Chassis.Internal;

partial model DetailedChassisBase

  extends BobLib.Icons.TwoAxleVehicleCoreIcon;
  ...
  // Front axle
  replaceable BobLib.Chassis.Suspension.FrAxleDW_BC_Stabar frAxleDW annotation(
    Placement(transformation(origin = {0.464283, 63}, extent = {{-64.25, -28.5556}, {64.25, 28.5556}})));

  // Rear axle
  replaceable BobLib.Chassis.Suspension.RrAxleDW_BC_Stabar rrAxleDW annotation(
    Placement(transformation(origin = {0.285708, -60.2776}, extent = {{-60.1429, -23.3889}, {60.1429, 23.3889}})));

  // Frame
  replaceable BobLib.Chassis.Body.FrameBase spaceFrame annotation(
