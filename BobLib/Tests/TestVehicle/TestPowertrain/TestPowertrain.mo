...
model TestPowertrain
  ...
  Modelica.Mechanics.Rotational.Components.Fixed differentialSupport annotation(
...
equation
  ...
  connect(differential.support, differentialSupport.flange) annotation(
    Line(points = {{20, -10}, {20, -50}}));
