...
partial model ChassisBase
  ...
  // Front axle
  replaceable BobLib.Vehicle.Chassis.Suspension.FrAxleDW_BC frAxleDW annotation(
    Placement(transformation(origin = {0.464283, 63}, extent = {{-64.25, -28.5556}, {64.25, 28.5556}})));
  
  // Rear axle
  replaceable BobLib.Vehicle.Chassis.Suspension.RrAxleDW_BC rrAxleDW annotation(
