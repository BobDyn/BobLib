...
model Motor
  ...
  BobLib.ElectricDrives.Internal.PowerLimitedMotor motor(
    Vdc_max = Vdc_max,
...
<p>
Thin adapter around <code>BobLib.ElectricDrives.Internal.PowerLimitedMotor</code>.
