...
model TestRrAxleDW
  ...
  parameter Real leftCPInit[3] = pVehicle.pRrDW.wheelCenter + Frames.resolve1(
    Frames.axesRotations({1, 2, 3}, {pVehicle.pRrPartialWheel.staticGamma*pi/180, 0, pVehicle.pRrPartialWheel.staticAlpha*pi/180}, {0, 0, 0}),
  ...
  // Front axle
  BobLibVehicleInterfaces.Chassis.Suspension.RrAxleDW_BC_Stabar rrAxleDW(
    ...
    redeclare BobLibVehicleInterfaces.Chassis.Suspension.Tires.BaseTire leftTire(redeclare BobLibVehicleInterfaces.Chassis.Suspension.Tires.MF52.SlipModel.NoSlip slipModel),
    redeclare BobLibVehicleInterfaces.Chassis.Suspension.Tires.BaseTire rightTire(redeclare BobLibVehicleInterfaces.Chassis.Suspension.Tires.MF52.SlipModel.NoSlip slipModel)) annotation(
...
equation
  ...
  connect(steerPosition.flange, rrAxleDW.steerFlange) annotation(
    Line(points = {{-40, 70}, {-10, 70}, {-10, 26}, {0, 26}}));
  connect(rrAxleDW.leftCP, left_DOF_xyz.frame_b) annotation(
