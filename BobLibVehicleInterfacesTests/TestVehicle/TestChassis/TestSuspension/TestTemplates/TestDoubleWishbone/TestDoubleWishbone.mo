within BobLibVehicleInterfacesTests.TestVehicle.TestChassis.TestSuspension.TestTemplates.TestDoubleWishbone;
...
model TestDoubleWishbone
  ...
  // Rack
  BobLibVehicleInterfaces.Chassis.Suspension.Templates.SteeringRack.RackAndPinion rackAndPinion(pRack = pVehicle.pFrRack,
  ...
  BobLibVehicleInterfaces.Chassis.Suspension.Templates.DoubleWishbone.WishboneUprightLoop wishboneUprightLoop(pDW = pVehicle.pFrDW,
  ...
  // Tie rod
  BobLibVehicleInterfaces.Chassis.Suspension.Linkages.Rod tieRod(r_a = pVehicle.pFrRack.leftPickup,
