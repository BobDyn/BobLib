...
// Outputs
  ...
  BobLibVehicleInterfaces.Chassis.Suspension.Tires.MF52Tire tireFL(pPartialWheel = pCar.pFrPartialWheel,
                                                                    ...
                                                                    redeclare BobLibVehicleInterfaces.Chassis.Suspension.Tires.MF52.SlipModel.KinematicSlip slipModel) annotation(
  ...
  BobLibVehicleInterfaces.Chassis.Suspension.Tires.MF52Tire tireFR(pPartialWheel = PartialWheelRecord(R0 = pCar.pFrPartialWheel.R0,
                                                                    ...
                                                                    pTireModel = pCar.pFrTireModel,
                                                                    redeclare BobLibVehicleInterfaces.Chassis.Suspension.Tires.TirePhysics.Wheel1DOF_Y wheelModel(partialWheelParams = PartialWheelRecord(R0 = pCar.pFrPartialWheel.R0,
                                                                                                                                                                                                          rimR0 = pCar.pFrPartialWheel.rimR0,
                                                                                                                                                                                                          rimWidth = pCar.pFrPartialWheel.rimWidth,
                                                                                                                                                                                                          staticAlpha = -pCar.pFrPartialWheel.staticAlpha,
                                                                                                                                                                                                          staticGamma = -pCar.pFrPartialWheel.staticGamma),
  ...
  BobLibVehicleInterfaces.Utilities.Mechanics.MultiBody.ContactMechanics.GroundPhysics groundFL annotation(
    Placement(transformation(origin = {-70, 40}, extent = {{-10, -10}, {10, 10}})));
  BobLibVehicleInterfaces.Utilities.Mechanics.MultiBody.ContactMechanics.GroundPhysics groundFR annotation(
    Placement(transformation(origin = {70, 40}, extent = {{10, -10}, {-10, 10}})));
  BobLibVehicleInterfaces.Utilities.Mechanics.MultiBody.ContactMechanics.GroundPhysics groundRL annotation(
    Placement(transformation(origin = {-70, -40}, extent = {{-10, -10}, {10, 10}})));
  BobLibVehicleInterfaces.Utilities.Mechanics.MultiBody.ContactMechanics.GroundPhysics groundRR annotation(
    Placement(transformation(origin = {70, -40}, extent = {{10, -10}, {-10, 10}})));
