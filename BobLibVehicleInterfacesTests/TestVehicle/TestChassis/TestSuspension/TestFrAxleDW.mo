within BobLibVehicleInterfacesTests.TestVehicle.TestChassis.TestSuspension;
...
model TestFrAxleDW
  ...
  Modelica.Blocks.Sources.Ramp rightJounceRamp(duration = 1, height = -1*0.0254, startTime = 0) annotation(
    Placement(transformation(origin = {110, 0}, extent = {{10, -10}, {-10, 10}}, rotation = -0)));
  // Front axle
  BobLibVehicleInterfaces.Chassis.Suspension.FrAxleDW_BC_Stabar frAxleDW(pAxle = pVehicle.pFrAxleDW, pRack = pVehicle.pFrRack, pStabar = pVehicle.pFrStabar, pLeftPartialWheel = pVehicle.pFrPartialWheel, pLeftDW = pVehicle.pFrDW, pLeftAxleMass = pVehicle.pFrAxleMass,
//  redeclare BobLibVehicleInterfaces.Chassis.Suspension.Linkages.Rod leftTieRod(r_a = frAxleDW.pRack.leftPickup, r_b = frAxleDW.pLeftDW.tie_o , kinematicConstraint = true),
//  redeclare BobLibVehicleInterfaces.Chassis.Suspension.Linkages.Rod rightTieRod(r_a = Vector.mirrorXZ(pVehicle.pFrRack.leftPickup), r_b = Vector.mirrorXZ(pVehicle.pFrDW.tie_o), kinematicConstraint = true),
  redeclare BobLibVehicleInterfaces.Chassis.Suspension.Tires.BaseTire leftTire(redeclare BobLibVehicleInterfaces.Chassis.Suspension.Tires.MF52.SlipModel.NoSlip slipModel), redeclare BobLibVehicleInterfaces.Chassis.Suspension.Tires.BaseTire rightTire(redeclare BobLibVehicleInterfaces.Chassis.Suspension.Tires.MF52.SlipModel.NoSlip slipModel)) annotation(
