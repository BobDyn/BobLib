...
// Record parameters
  ...
  // Lower wisbone
  Modelica.Mechanics.MultiBody.Joints.Revolute lowerJoint_i(n = Vectors.normalize(pDW.lowerFore_i - pDW.lowerAft_i), cylinderLength = Vectors.norm(pDW.lowerFore_i - pDW.lowerAft_i) + linkDiameter, cylinderDiameter = linkDiameter, phi(displayUnit = "rad")) annotation(
  ...
  // Steering interface
  Modelica.Mechanics.MultiBody.Joints.Revolute steeringAxis(n = Vectors.normalize(pDW.upper_o - pDW.lower_o), cylinderLength = jointDiameter, cylinderDiameter = jointDiameter, phi(nominal = 0.1)) annotation(
...
equation
  upperForeLinkDirection = Frames.resolve2(upperFrameToFore.frame_b.R, Vectors.normalize(upperFrame_o.r_0 - upperFrameToFore.frame_b.r_0));
  upperForeLinkLength = Vectors.norm(upperFrame_o.r_0 - upperFrameToFore.frame_b.r_0);
  upperAftLinkDirection = Frames.resolve2(upperFrameToAft.frame_b.R, Vectors.normalize(upperFrame_o.r_0 - upperFrameToAft.frame_b.r_0));
  upperAftLinkLength = Vectors.norm(upperFrame_o.r_0 - upperFrameToAft.frame_b.r_0);
  lowerForeLinkDirection = Frames.resolve2(lowerFrameToFore.frame_b.R, Vectors.normalize(lowerFrame_o.r_0 - lowerFrameToFore.frame_b.r_0));
  lowerForeLinkLength = Vectors.norm(lowerFrame_o.r_0 - lowerFrameToFore.frame_b.r_0);
  lowerAftLinkDirection = Frames.resolve2(lowerFrameToAft.frame_b.R, Vectors.normalize(lowerFrame_o.r_0 - lowerFrameToAft.frame_b.r_0));
