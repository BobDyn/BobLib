...
model WishboneUprightLoop "Kinematic loop consisting of upright, lower wishbone, and upper wishbone"
  ...
  Modelica.Mechanics.MultiBody.Visualizers.FixedShape upperForeRod(shapeType = "cylinder",
                                                                   lengthDirection = upperForeLinkDirection,
                                                                   length = upperForeLinkLength,
                                                                   width = linkDiameter,
                                                                   height = linkDiameter,
                                                                   color = {0, 0, 0})  annotation(
    Placement(transformation(origin = {-40, 90}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Mechanics.MultiBody.Visualizers.FixedShape upperAftRod(shapeType = "cylinder",
                                                                  lengthDirection = upperAftLinkDirection,
  ...
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation lowerFrameToAft(r = (pDW.lowerAft_i - pDW.lowerFore_i) / 2)  annotation(
    Placement(transformation(origin = {-70, -90}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Mechanics.MultiBody.Visualizers.FixedShape lowerForeRod(shapeType = "cylinder",
                                                                   lengthDirection = lowerForeLinkDirection,
                                                                   length = lowerForeLinkLength,
                                                                   width = linkDiameter,
                                                                   height = linkDiameter,
                                                                   color = {0, 0, 0}) annotation(
    Placement(transformation(origin = {-40, -30}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Mechanics.MultiBody.Visualizers.FixedShape lowerAftRod(shapeType = "cylinder",
                                                                  lengthDirection = lowerAftLinkDirection,
