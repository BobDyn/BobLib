...
partial model VehicleBase
  ...
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation toAeroFrame(r = -1 * chassis.spaceFrame.pSprung.rCM) annotation(
...
equation
  aeroModel.frontRideHeight = 1 * 0.0254;
  aeroModel.rearRideHeight = 1 * 0.0254;
  ...
  connect(chassis.cgFrame, toAeroFrame.frame_a) annotation(
    Line(points = {{58, 0}, {-20, 0}}, color = {95, 95, 95}));
