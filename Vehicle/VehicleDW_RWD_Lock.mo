...
model VehicleDW_RWD_Lock
  ...
  extends BobLib.Vehicle.VehicleBase(redeclare BobLib.Vehicle.Chassis.ChassisDW_BC_ARB chassis(redeclare BobLib.Vehicle.Chassis.Suspension.FrAxleDW_BC_ARB frAxleDW(pAxle = pVehicle.pFrAxleDW,
                                                                                                                                                                    ...
                                                                                                                                                                    redeclare Tire.MF52Tire leftTire(pPartialWheel = pVehicle.pFrPartialWheel,
                                                                                                                                                                                                     pTireModel = pVehicle.pFrTireModel,
                                                                                                                                                                                                     redeclare Tire.TirePhysics.Wheel2DOF_YZ wheelModel(partialWheelParams = pVehicle.pFrPartialWheel,
                                                                                                                                                                                                                                                        wheel1DOF_YParams = pVehicle.pFrTire1DOF_YParams,
                                                                                                                                                                                                                                                        wheel1DOF_ZParams = pVehicle.pFrTire1DOF_ZParams),
                                                                                                                                                                                                     redeclare Tire.MF52.SlipModel.TransientSlip slipModel),
                                                                                                                                                                    redeclare Tire.MF52Tire rightTire(pPartialWheel = pVehicle.pFrPartialWheel,
                                                                                                                                                                                                      pTireModel = pVehicle.pFrTireModel,
                                                                                                                                                                                                      redeclare Tire.TirePhysics.Wheel2DOF_YZ wheelModel(partialWheelParams = pVehicle.pFrPartialWheel,
                                                                                                                                                                                                                                                         wheel1DOF_YParams = pVehicle.pFrTire1DOF_YParams,
                                                                                                                                                                                                                                                         wheel1DOF_ZParams = pVehicle.pFrTire1DOF_ZParams), 
                                                                                                                                                                                                      redeclare Tire.MF52.SlipModel.TransientSlip slipModel)),
                                                                                               redeclare BobLib.Vehicle.Chassis.Suspension.RrAxleDW_BC_ARB rrAxleDW(pAxle = pVehicle.pRrAxleDW,
                                                                                                                                                                    ...
                                                                                                                                                                    redeclare Tire.MF52Tire leftTire(pPartialWheel = pVehicle.pRrPartialWheel,
                                                                                                                                                                                                     pTireModel = pVehicle.pRrTireModel,
                                                                                                                                                                                                     redeclare Tire.TirePhysics.Wheel2DOF_YZ wheelModel(partialWheelParams = pVehicle.pRrPartialWheel,
                                                                                                                                                                                                                                                        wheel1DOF_YParams = pVehicle.pRrTire1DOF_YParams,
                                                                                                                                                                                                                                                        wheel1DOF_ZParams = pVehicle.pRrTire1DOF_ZParams),
                                                                                                                                                                                                     redeclare Tire.MF52.SlipModel.TransientSlip slipModel),
                                                                                                                                                                    redeclare Tire.MF52Tire rightTire(pPartialWheel = pVehicle.pRrPartialWheel,
                                                                                                                                                                                                      pTireModel = pVehicle.pRrTireModel,
                                                                                                                                                                                                      redeclare Tire.TirePhysics.Wheel2DOF_YZ wheelModel(partialWheelParams = pVehicle.pRrPartialWheel,
                                                                                                                                                                                                                                                         wheel1DOF_YParams = pVehicle.pRrTire1DOF_YParams,
                                                                                                                                                                                                                                                         wheel1DOF_ZParams = pVehicle.pRrTire1DOF_ZParams), 
