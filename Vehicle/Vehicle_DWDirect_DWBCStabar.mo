...
model Vehicle_DWDirect_DWBCStabar
  ...
  extends BobLib.Vehicle.VehicleBase(
    redeclare BobLib.Vehicle.Chassis.Chassis_LockRrSteer chassis(
      redeclare BobLib.Vehicle.Chassis.Suspension.FrAxleDW_Direct frAxleDW(pAxle = fr_pVehicle.pFrAxleDW,
...
end Vehicle_DWDirect_DWBCStabar;
