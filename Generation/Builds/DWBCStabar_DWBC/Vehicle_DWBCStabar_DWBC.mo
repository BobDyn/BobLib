...
model Vehicle_DWBCStabar_DWBC
  import BobLib.Vehicle.Chassis.Suspension.Templates.Tire;
  import BobLib.Resources.VehicleDefn.DWBCStabar_DWBCRecord;

  // Record parameters
  parameter DWBCStabar_DWBCRecord pVehicle;
