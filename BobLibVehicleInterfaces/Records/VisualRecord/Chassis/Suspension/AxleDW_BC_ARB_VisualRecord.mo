within BobLibVehicleInterfaces.Records.VisualRecord.Chassis.Suspension;

record AxleDW_BC_ARB_VisualRecord

  extends BobLibVehicleInterfaces.Records.VisualRecord.Chassis.Suspension.AxleDWBaseVisualRecord;
