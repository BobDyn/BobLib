...
<p>
Record <code>EVBatInvMotDiff_DWBCStabar_DWBCStabarRecord</code> defines the EV battery-inverter-motor-differential vehicle configuration with front bellcrank-actuated double wishbone suspension with a stabilizer bar and rear bellcrank-actuated double wishbone suspension with a stabilizer bar.
</p>
<p>
...
end EVBatInvMotDiff_DWBCStabar_DWBCStabarRecord;
