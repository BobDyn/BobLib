...
record EVBatInvMotDiff_DWBCStabar_DWBCRecord
...
<p>
Record <code>EVBatInvMotDiff_DWBCStabar_DWBCRecord</code> defines the EV battery-inverter-motor-differential vehicle configuration with front bellcrank-actuated double wishbone suspension with a stabilizer bar and rear bellcrank-actuated double wishbone suspension.
</p>
<p>
...
end EVBatInvMotDiff_DWBCStabar_DWBCRecord;
