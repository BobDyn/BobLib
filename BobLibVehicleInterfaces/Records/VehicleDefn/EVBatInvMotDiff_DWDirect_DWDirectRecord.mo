...
record EVBatInvMotDiff_DWDirect_DWDirectRecord
  ...
  parameter Axle.Templates.AxleMassRecord pFrAxleMass(
      unsprungMass = MassRecord(m = 7.82268281, rCM = {-0.00611067, 0.60164333, 0.1980248}, inertia = {{0.10584698, 0.00036654, 0.00061019}, {0.00036654, 0.16067787, -0.00076932}, {0.00061019, -0.00076932, 0.1081089}}),
  ...
  parameter Axle.Templates.AxleMassRecord pRrAxleMass(
      unsprungMass = MassRecord(m = 7.35220072, rCM = {-1.54081056, 0.59989818, 0.20113454}, inertia = {{0.15501895, -0.07141018, 0.00044628}, {-0.07141018, 0.25694304, -0.00178752}, {0.00044628, -0.00178752, 0.25436752}}),
