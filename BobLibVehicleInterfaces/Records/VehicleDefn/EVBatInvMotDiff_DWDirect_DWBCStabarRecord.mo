...
record EVBatInvMotDiff_DWDirect_DWBCStabarRecord
...
<p>
Record <code>EVBatInvMotDiff_DWDirect_DWBCStabarRecord</code> defines the EV battery-inverter-motor-differential vehicle configuration with front direct-acting double wishbone suspension and rear bellcrank-actuated double wishbone suspension with a stabilizer bar.
</p>
<p>
...
end EVBatInvMotDiff_DWDirect_DWBCStabarRecord;
