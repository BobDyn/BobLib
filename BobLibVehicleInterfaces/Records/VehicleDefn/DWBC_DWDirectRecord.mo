...
<p>
Record <code>DWBC_DWDirectRecord</code> defines a complete vehicle with front bellcrank-actuated double wishbone suspension and rear direct-acting double wishbone suspension.
</p>
<p>
