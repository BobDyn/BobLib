...
record DWDirect_DWDirectRecord
...
<p>
Record <code>DWDirect_DWDirectRecord</code> defines a complete vehicle with front direct-acting double wishbone suspension and rear direct-acting double wishbone suspension.
</p>
<p>
