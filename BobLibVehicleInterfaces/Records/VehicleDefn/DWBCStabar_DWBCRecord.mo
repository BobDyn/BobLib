...
<p>
Record <code>DWBCStabar_DWBCRecord</code> defines a complete vehicle with front bellcrank-actuated double wishbone suspension with a stabilizer bar and rear bellcrank-actuated double wishbone suspension.
</p>
<p>
