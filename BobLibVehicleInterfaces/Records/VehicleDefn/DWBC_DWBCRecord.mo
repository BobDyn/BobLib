...
<p>
Record <code>DWBC_DWBCRecord</code> defines a complete vehicle with front bellcrank-actuated double wishbone suspension and rear bellcrank-actuated double wishbone suspension.
</p>
<p>
