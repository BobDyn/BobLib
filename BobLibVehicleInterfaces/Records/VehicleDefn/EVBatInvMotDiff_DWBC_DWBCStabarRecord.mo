...
record EVBatInvMotDiff_DWBC_DWBCStabarRecord
...
<p>
Record <code>EVBatInvMotDiff_DWBC_DWBCStabarRecord</code> defines the EV battery-inverter-motor-differential vehicle configuration with front bellcrank-actuated double wishbone suspension and rear bellcrank-actuated double wishbone suspension with a stabilizer bar.
</p>
<p>
...
end EVBatInvMotDiff_DWBC_DWBCStabarRecord;
