within BobLibVehicleInterfaces.Records.VehicleRecord.Chassis.Suspension.Templates.DoubleWishbone;
...
<p>
Record <code>WishboneUprightLoopRecord</code> stores double-wishbone hardpoints for one suspension corner.
</p>
<p>
It defines inner and outer control-arm pickups, tie-rod pickup, and wheel-center location used by the wishbone/upright loop model.
</p>
</html>"));
