...
partial model ShockLinkageIcon "Reusable shock linkage icon"
  annotation(
    Icon(graphics = {
      Line(origin = {1, -40}, points = {{-61, 0}, {-41, 0}, {-31, 20}, {-11, -20}, {11, 20}, {29, -20}, {39, 0}, {59, 0}}, thickness = 3),
      ...
      Line(origin = {-29.91, -67.91}, points = {{-2.0908, 7.9092}, {39.9092, 17.9092}, {59.9092, 47.9092}}, color = {255, 0, 0}, thickness = 3),
      Line(origin = {9.96, 38.96}, points = {{-39.9639, -30.9639}, {-9.96392, 21.0361}, {20.0361, 31.0361}}, color = {255, 0, 0}, thickness = 3),
