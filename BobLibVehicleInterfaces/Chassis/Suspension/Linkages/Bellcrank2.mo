...
model Bellcrank2
  extends BobLibVehicleInterfaces.Icons.Bellcrank2Icon;
  ...
  Modelica.Mechanics.MultiBody.Visualizers.FixedShape side_3(lengthDirection = Vectors.normalize(pivot - pickup_2), length = Vectors.norm(pivot - pickup_2), width = linkDiameter*0.75, height = linkDiameter*0.75, widthDirection = Vectors.normalize(pivotAxis), shapeType = "cylinder", animation = not headless) annotation(
...
<p>
Model <code>Bellcrank2</code> represents a suspension bellcrank with two driven pickups.
</p>
<p>
