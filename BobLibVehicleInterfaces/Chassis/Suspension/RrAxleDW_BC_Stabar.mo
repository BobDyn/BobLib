...
model RrAxleDW_BC_Stabar "Double wishbone axle with bellcranks mounting to shock, push/pullrod, and stabar"
  ...
  // Left bellcrank
  BobLibVehicleInterfaces.Chassis.Suspension.Linkages.Bellcrank3 leftBellcrank(
  ...
  // Right bellcrank
  BobLibVehicleInterfaces.Chassis.Suspension.Linkages.Bellcrank3 rightBellcrank(
  ...
  // Stabar
  BobLibVehicleInterfaces.Chassis.Suspension.Templates.Stabar.Stabar stabar(
    pStabar = pStabar,
