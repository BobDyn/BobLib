...
model BaseTire
  extends BobLibVehicleInterfaces.Icons.BaseTireIcon;
  ...
  replaceable BobLibVehicleInterfaces.Chassis.Suspension.Tires.TirePhysics.Wheel0DOF wheelModel(partialWheelParams = pPartialWheel) annotation(
    Placement(transformation(extent = {{-30, -30}, {30, 30}})));
  replaceable BobLibVehicleInterfaces.Chassis.Suspension.Tires.MF52.SlipModel.KinematicSlip slipModel annotation(
  ...
  Modelica.Mechanics.MultiBody.Forces.WorldForceAndTorque forceAndTorque(resolveInFrame = Modelica.Mechanics.MultiBody.Types.ResolveInFrameB.frame_b, animation = not headless) annotation(
