...
model Wheel1DOF_Z
  ...
  extends BobLibVehicleInterfaces.Chassis.Suspension.Tires.TirePhysics.Templates.PartialWheel(inertia(J = 0.01));
...
<p>
Model <code>Wheel1DOF_Z</code> represents a wheel physics variant with 1DOF Z behavior.
</p>
<p>
