...
partial model BaseFourPostSim
  ...
  replaceable record VehicleRecord = BobLibVehicleInterfaces.Records.VehicleDefn.DWBCStabar_DWBCStabarRecord;
  replaceable model FrAxleModel =
    BobLibVehicleInterfaces.Experiments.Standards.Templates.FourPostFrAxleDW_BC_Stabar
    constrainedby BobLibVehicleInterfaces.Chassis.Suspension.AxleDWBase;
  replaceable model RrAxleModel =
    BobLibVehicleInterfaces.Experiments.Standards.Templates.FourPostRrAxleDW_BC_Stabar
    constrainedby BobLibVehicleInterfaces.Chassis.Suspension.AxleDWBase;
