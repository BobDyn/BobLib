...
model ContactPatchForceActuator
...
<p>
Model <code>ContactPatchForceActuator</code> applies prescribed force inputs at
a MultiBody frame, typically a tire contact patch in a rig-level test.
</p>
<p>
