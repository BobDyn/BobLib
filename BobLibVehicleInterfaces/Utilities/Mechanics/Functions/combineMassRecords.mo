...
<p>
Function <code>combineMassRecords</code> combines multiple mass-property records
into one equivalent mass record.
</p>
<p>
It computes the total mass, mass-weighted center of mass, and inertia
translated to the combined center using the parallel-axis theorem.
</p>
</html>"));
